...
public class ScheduleRepositoryImplement implements ScheduleRepository {
    ...
    public ScheduleRepositoryImplement(DataSource dataSource) {
    ...
    public ScheduleResponse_Lv3 findById(int scheduleId) {
        String sql = "SELECT s.schedule_id AS scheduleId, s.user_id AS userId, s.title, u.name AS writer, s.scheduled_date, s.created_at, s.modified_at "
