...
import schedulemanager.repository.ScheduleRepository;
import schedulemanager.repository.UserRepository_Lv3;
...
public class ScheduleServiceImplement implements ScheduleService {
    ...
    public int createSchedule(ScheduleRequest_Lv3 request) {
        ...
        if (existing == null) {
            var newUser = new schedulemanager.repository.User_Lv3(request.getWriter(), request.getEmail());
